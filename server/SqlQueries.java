...
public interface SqlQueries {
	...
	static final String GET_STUDENT_ASSIGNMENT = "SELECT A.ID, A.TITLE, CASE WHEN S.STUDENT_ID IS NULL THEN 0b0 ELSE 0b1 END SUBMITTED, A.DUE_DATE, A.EXTENSION FROM ASSIGNMENT A LEFT JOIN SUBMISSION S ON S.ASSIGN_ID = A.ID AND S.STUDENT_ID = ? WHERE A.COURSE_ID = ? AND A.ACTIVE = 0b1 ORDER BY A.DUE_DATE";
