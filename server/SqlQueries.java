...
public interface SqlQueries {
	...
	static final String GET_PROF_ASSIGNMENT = "SELECT ID, TITLE, ACTIVE, DUE_DATE FROM ASSIGNMENT WHERE COURSE_ID = ? ORDER BY DUE_DATE"; // TODO gets non-active assignments for students
	static final String GET_STUDENT_ASSIGNMENT = "SELECT ID, TITLE, EXTENSION, DUE_DATE FROM ASSIGNMENT WHERE COURSE_ID = ? AND ACTIVE = 0b1 ORDER BY DUE_DATE";
